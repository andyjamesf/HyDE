...
// Nerd Font glyph picker for the island launcher (port of HyDE's glyph-picker.sh).
...
// Recents (PickersConfig.recents.glyph) are kept by PickerStore under the key "glyph".
...
Singleton {
    ...
    readonly property string textFont: Config.Appearance.nerdFont

    readonly property int maxResults: Config.PickersConfig.maxResults.glyph ?? 300
