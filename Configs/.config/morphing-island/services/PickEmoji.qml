...
// Emoji picker for the island launcher (port of HyDE's emoji-picker.sh).
...
// Recents (PickersConfig.recents.emoji) are kept by PickerStore under the key "emoji".
//
...
Singleton {
    ...
    readonly property int maxResults: Config.PickersConfig.maxResults.emoji ?? 300
