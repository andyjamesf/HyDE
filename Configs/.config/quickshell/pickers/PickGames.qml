...
// Games picker for the launcher (port of HyDE's gamelauncher.sh, "catalog" backend, which
...
Singleton {
    ...
    readonly property int maxResults: Config.pickers.maxResults.games ?? 200
