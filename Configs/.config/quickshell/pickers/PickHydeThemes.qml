...
Singleton {
    ...
    function activate(item) {
        ...
        // theme.switch.sh takes a few seconds and must finish even if the shell restarts:
        // Hyde.initRun goes through Launch.run (its own unit, outside the shell's cgroup).
